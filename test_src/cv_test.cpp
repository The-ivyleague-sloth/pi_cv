...
int main( )
{
    ...
    image1 = imread("/home/ivyleaguesloth/BullyBot/cv/test_images/opencv-logo.jpg",CV_LOAD_IMAGE_COLOR);
    if( !image1.data ) { printf("Error loading image1 \n"); return -1;}
    image2 = imread("/home/ivyleaguesloth/BullyBot/cv/test_image/opencv-test.png",CV_LOAD_IMAGE_COLOR);
